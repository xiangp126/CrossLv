" Vim color file - miniordc
" derived from jellybeans and mixed with mydefault.vim
" Generated by http://bytefluent.com/vivify 2018-01-21
set background=dark
if version > 580
	hi clear
	if exists("syntax_on")
